...
// Lightweight scroll-reveal wrapper — no dependency, respects prefers-reduced-motion.
// Mirrors the same pattern used on the homepage for visual consistency site-wide.
function Reveal({ children, as: Tag = "div", className = "" }: { children: React.ReactNode; as?: any; className?: string }) {
      ...
      <main>
        ...
        <section className="bg-[#F8F1E8] py-20">
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8">
            <Reveal>
              <div className="rounded-[28px] border border-[#E8DBCD] bg-[#FFFDF9] p-10 shadow-[0_10px_30px_rgba(0,0,0,0.04)] h-full">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[
                ...
                <Reveal key={item.number}>
                  <div className="rounded-[28px] border border-[#EEE2D7] bg-[#FFFDF9] p-10 text-center shadow-[0_10px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_16px_40px_rgba(0,0,0,0.06)] transition h-full">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[
                ...
                <Reveal key={stat.label}>
                  <div className="rounded-[28px] border border-[#E8DBCD] bg-[#FFFDF9] p-8 text-center shadow-[0_10px_30px_rgba(0,0,0,0.04)] h-full">
