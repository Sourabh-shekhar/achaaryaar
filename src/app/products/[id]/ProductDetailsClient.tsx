...
export default function ProductDetailsClient({
  ...
  return (
    <div className="min-h-screen bg-[#FBF7F1] py-16 pb-32 relative">
      ...
      {toast && (
        <div className="fixed top-6 right-6 z-50 bg-[#3D5640] text-white px-6 py-4 rounded-xl shadow-2xl flex items-center gap-3">
                ...
                {gallery.map(
                  (media, index) => (
                    <button
                      ...
                      className={`relative h-14 w-14 flex-shrink-0 overflow-hidden rounded-lg border-2 transition sm:h-16 sm:w-16 ${
                        modalImageIndex ===
                        index
                          ? "border-white"
                          : "border-white/30 opacity-70 hover:opacity-100"
      ...
      <div className="max-w-7xl mx-auto px-6 mb-8 text-sm text-[#7A6F65]">
        ...
        <Link
          href="/"
          className="hover:text-[#C18A42] transition"
        >
          Home
        </Link>
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16">
        ...
        <div>
          ...
          >
            ...
            {activeMedia?.type ===
              "video" && (
              <span className="absolute right-4 top-4 rounded-full bg-black/55 px-3 py-1.5 text-xs font-semibold text-white pointer-events-none">
                PRODUCT VIDEO
              </span>
            )}
            ...
            {gallery.length > 1 && (
              <span className="absolute bottom-4 right-4 rounded-full bg-black/55 px-3 py-1 text-xs font-semibold text-white pointer-events-none">
                {activeImage + 1} /{" "}
                {gallery.length}
              </span>
            )}
                  ...
                  >
                    ...
                    "image" ? (
                      ...
                      <>
                        ...
                        <div className="absolute inset-0 flex items-center justify-center bg-black/30">
                          <div className="flex h-9 w-9 items-center justify-center rounded-full bg-white/90 text-[#7A2E2E] text-sm shadow-lg">
                            ▶
                          </div>
                        </div>
        ...
        <div>
          ...
          {outOfStock ? (
            <div className="mt-8 bg-white border border-[#E8DDD1] rounded-2xl p-6">
              ...
              <p className="text-[#7A6F65] text-sm mb-4">
                Leave your email and we'll let
                you know the moment it's back.
              </p>
            ...
            <div className="hidden sm:grid grid-cols-2 gap-3 mt-8">
              ...
              <button
                onClick={handleAddToCart}
                disabled={outOfStock}
                className={`py-4 rounded-2xl text-lg font-bold transition shadow-md ${
                  added
                    ? "bg-[#4F6B52] text-white"
                    : "bg-[#1877F2] hover:bg-[#166FE5] text-white"
                }`}
            ...
            "description" && (
              <div className="bg-[#FFFDF8] rounded-2xl sm:rounded-3xl p-5 sm:p-10">
                ...
                <div className="flex items-center justify-center my-6 sm:my-8">
                  ...
                  <div className="h-[1px] flex-1 bg-[#D6C5AE]" />
                ...
                <div className="max-w-5xl mx-auto">
                  ...
                  <div className="space-y-5 sm:space-y-6 text-[15px] leading-7 sm:text-lg sm:leading-8 md:text-xl md:leading-10 text-[#3B342D]">
                    ...
                    <div>
                      <span className="font-bold text-[#2F5533]">
                        Ingredients :
                      </span>{" "}
                      Main seasonal ingredient,
                      mustard oil, salt, mustard
                      seeds, fennel, fenugreek,
                      turmeric, chilli, hing, and
