...
//       {/* Related Products */}
//   <section className="max-w-7xl mx-auto px-6 mt-24 opacity-100">
...
//         className="block bg-white rounded-3xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 opacity-100"
//       >
//         <img
//           src={item.image}
//           alt={item.name}
